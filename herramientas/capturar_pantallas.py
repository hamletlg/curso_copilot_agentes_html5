...
DESTINO = RAIZ / "entregables" / "capturas" / "rev6"
PUERTO = 9334
...
PAGINAS = [
    ...
    ("04_sobreexposicion_permisos", "html/18-permisos-sobreexposicion-y-shadow-ai.html", 1280, 900),
    ("05_ejercicios", "html/23-ejercicios-practicos.html", 1280, 900),
    ("06_evaluacion_final", "html/24-evaluacion-final.html", 1280, 900),
    ("07_portada_movil", "index.html", 420, 900),
]
...
async def main():
    ...
    async with websockets.connect(ws_url, max_size=None) as ws:
        ...
        for nombre, ruta, ancho, alto in PAGINAS:
            ...
            # despliega el primer acordeón si la página tiene uno (para que se vea la interacción)
            if "acordeon" in nombre or nombre == "04_sobreexposicion_permisos":
